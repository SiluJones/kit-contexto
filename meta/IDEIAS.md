...
## i-N19 — Diretriz: verificar o estado atual antes de repetir um STATUS possivelmente velho — ✅ VALIDADA (a embutir)
...
## i-N20 — Formato do bloco de commit: três comandos em linhas separadas + `git add .` — ✅ DEFINIDA
...
## i-N21 — Comando/template de FEEDBACK (capturar fricção de uso e rotear para os docs) — ✅ FECHADA (escopo ampliado)
...
## i-N22 — Não engessar na estrutura genérica: pular templates e propor outros .md por projeto/grupo — ✅ VALIDADA (texto aprovado)
