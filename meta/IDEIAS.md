...
## i-N18 — Diretriz: ler o MANIFEST para o nome certo no upload achatado — A REDIGIR (do usuário)
...
## i-N19 — Diretriz: verificar o estado atual antes de repetir um STATUS possivelmente velho — A REDIGIR (do usuário)
...
## i-N20 — Formato do bloco de commit: três comandos em linhas separadas + `git add .` — A DEFINIR (do usuário)
...
## i-N21 — Comando/template de FEEDBACK (capturar fricção de uso e rotear para os docs) — A AVALIAR (do usuário)
...
## i-N22 — Não engessar na estrutura genérica: pular templates e propor outros .md por projeto/grupo — A AVALIAR (do usuário)
