...
- **Seletor de SO (v1.11.0):** injeta sintaxe de comando certa em Instruções e CLAUDE.md.
- **Afixo nos downloads (v1.9.0):** prefixo/sufixo opcional.
- **9 princípios universais**; CLAUDE.md separado; commit no formato CMD Windows.

## 🔧 Pendências e ideias em análise (em IDEIAS.md)
- [ ] **i-N3 parte A** (canal de atualização do kit): a discutir.
...
- Decisões registradas; histórico que cresce; STATUS rolante; núcleo enxuto + opcionais.
- Prompts A-F universais + 6 G-L específicos das tarefas reais.
- Behaviors derivados de pesquisa. Para criativos: forte ênfase em "explora/critica — o criador executa/decide".
